...
namespace HotelV4.aclass
{
    class Accout
    {
        ...
        public Accout() { }
        public Accout(string userName, string displayName, string passWord, int staffType, string idCard, DateTime dateOfBirth, string sex, string address, int phoneNumber, DateTime startDay)
        {
        ...
        public bool Equals(Accout accountPre)
        {
            if (accountPre == null)
                return false;
